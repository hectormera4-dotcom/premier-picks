...
Deno.serve(async (req: Request) => {
  ...
  // Un poco mas laxo que payphone-prepare: la pagina de retorno de
  // Payphone puede reintentar la confirmacion si el usuario recarga.
  if (excedeLimite(claveDesdeRequest(req), 10, 30_000)) {
